...
//	    this.updatedAt = LocalDateTime.now();
	 ...
	 */
	public void setstatusCreatedat(LocalDateTime createdat) {
		this.statusCreatedAt = createdat;
	}
	
	/**
	 * @return createdat
	 */
	public LocalDateTime gettrophyCreatedat() {
		return trophyCreatedAt;
	}
	/**
	 * @param createdat セットする createdat
	 */
	public void settrophyCreatedat(LocalDateTime createdat) {
		this.trophyCreatedAt = createdat;
	}
	/**
	 ...
	 */
	public void statussetUpdateat(LocalDateTime updateat) {
		this.statusUpdatedAt = updateat;
	}
